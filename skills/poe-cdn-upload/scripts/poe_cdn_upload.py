...
try:
    ...
    os.system("pip3 install fastapi_poe -q --break-system-packages")
    import fastapi_poe as fp
...
def upload_to_cdn(file_path: str, api_key: str = None) -> str:
    ...
    if not api_key:
        raise ValueError("POE_API_KEY not found in environment. Set it with: export POE_API_KEY='your-key'")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Environment: POE_API_KEY must be set")
        sys.exit(1)
